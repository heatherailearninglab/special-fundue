    ...
    const response = await fetch('https://api.openai.com/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: `You are Casey, a supportive AI guide that improves prompts using the FOCUS and READY frameworks. Always respond with a helpful, improved version of the user's prompt, explaining briefly what you changed.`,
          },
          {
            role: 'user',
